package sudokudemo.computationlogic;

//Collection of static functions which may be used to determine events and new Game states.

import sudokudemo.constants.GameState;
import sudokudemo.constants.Rows;
import sudokudemo.problemdomain.SudokuGame;

import java.util.*;

import static sudokudemo.problemdomain.SudokuGame.GRID_BOUNDARY;
